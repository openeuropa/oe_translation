 ...
 */
class TranslationLocalTasks extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    foreach ($entity_types as $entity_type_id => $entity_type) {
      ...
      // @todo change this to the proper route for local translations.
      $this->derivatives["$entity_type_id.local_translations"] = [
