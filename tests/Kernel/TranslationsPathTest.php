 ...
 * @group tmgmt
 */
class TranslationsPathTest extends ContentEntityTestBase {
  ...
  public function testPathauto() {
    ...
    // Create a node with a path (with disabled pathauto).
    $values = [
      'langcode' => 'en',
      'type' => 'page',
      'uid' => 1,
    ...
    // The textfield for translating aliases should be available,
    // if pathauto for this node is disabled.
