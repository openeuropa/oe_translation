...
class RemoteTranslationTestController extends ControllerBase {
   ...
   *
   * @param \Drupal\oe_translation_remote_test\TranslationRequestTestRemote $oe_translation_request
   ...
   *   The current request.
   */
  public function translateRequest(TranslationRequestTestRemote $oe_translation_request, string $langcode, Request $request) {
