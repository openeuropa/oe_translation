 ...
 *   label = @Translation("ActiveRevision"),
 *   label_collection = @Translation("ActiveRevisions"),
 *   label_singular = @Translation("activerevision"),
 *   label_plural = @Translation("activerevisions"),
 *   label_count = @PluralTranslation(
 *     singular = "@count activerevisions",
 *     plural = "@count activerevisions",
 *   ),
 *   handlers = {
...
class ActiveRevision extends ContentEntityBase implements ActiveRevisionInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['created'] = BaseFieldDefinition::create('created')
      ...
      ->setDescription(t('The time that the activerevision was created.'))
      ->setDisplayOptions('view', [
        'label' => 'above',
        'type' => 'timestamp',
        'weight' => 20,
    ...
    $fields['changed'] = BaseFieldDefinition::create('changed')
      ->setLabel(t('Changed'))
      ->setDescription(t('The time that the activerevision was last edited.'));
